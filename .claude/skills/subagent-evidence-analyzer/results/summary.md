# Evidence Exclusion Analysis - Consolidated Summary

**Date:** 2026-01-21 (Consolidated)
**Source:** 31 commits analyzed

## Consolidated Statistics

| Metric | Value |
|--------|-------|
| Total Analyzed (max) | 810 |
| Full Exclusions (max) | 141 |
| Partial Exclusions (max) | 124 |
