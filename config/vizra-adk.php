...
return [
    ...
    /**
     * Agent registry for Vizra ADK discovery and orchestration.
     */
    'agents' => [
        'legal_artillery' => App\Agents\LegalArtilleryAgent::class,
        'legal_artillery_agent' => App\Agents\LegalArtilleryAgent::class,
    ],
     ...
     * Configure quality thresholds for OCR validation and re-processing decisions.
     */
    'ocr' => [
        /**
         * Minimum confidence score for OCR text (0.0 to 1.0).
         * Documents below this threshold will be flagged for review.
         */
        'min_confidence' => env('VIZRA_ADK_OCR_MIN_CONFIDENCE', 0.82),

        /**
         * Minimum text coverage percentage (0.0 to 1.0).
         * Documents with low coverage may indicate scanning issues.
         */
        'min_coverage' => env('VIZRA_ADK_OCR_MIN_COVERAGE', 0.75),

        /**
         * Maximum number of pages with low confidence scores before flagging.
         * Helps identify documents with inconsistent quality.
         */
        'max_low_confidence_pages' => env('VIZRA_ADK_OCR_MAX_LOW_CONF_PAGES', 3),

        /**
         * Skip embedding when OCR quality is below thresholds.
         * When true, low-quality documents won't be embedded in vector store.
         */
        'skip_embedding_on_low_quality' => env('VIZRA_ADK_OCR_SKIP_EMBEDDING_ON_LOW_QUALITY', false),
    ],
