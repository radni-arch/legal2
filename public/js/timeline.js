...
(() => {
                                ...
                                return (
                                    t(s, [
                                        ...
                                        },
                                        {
                                            ...
                                            value: function () {
                                                i.call(this._document.querySelectorAll("[inert]")).forEach(function (
                                                    t
                                                ) {
                                                    this.setInert(t, !0);
                                                }, this),
    ...
    (() => {
        ...
        function j(t) {
            ...
            for (var e = 0; e < 31; e++)
                t = t.replace(
                    new RegExp("Ã£Ã Ã¡Ã¤Ã¢áº½Ã¨Ã©Ã«ÃªÃ¬Ã­Ã¯Ã®ÃµÃ²Ã³Ã¶Ã´Ã¹ÃºÃ¼Ã»Ã±Ã§Â·/_,:;".charAt(e), "g"),
        ...
        class at {
            ...
            fire(t, e) {
                if (!this.hasEventListeners(t)) return this;
                for (
                    var i = E({ type: t, target: this }, e), a = this._tl_events[t].slice(), s = 0, n = a.length;
                    s < n;
                    s++
                )
        ...
        const nt = (function () {
            ...
            function k(t, e) {
                ...
                return (
                    ...
                    (i = t.match(m)) &&
                    ((a.skewx = A(i[1], e ? e.skewx : null)), (a.skewy = A(i[3], e ? e.skewy : null))),
                    (i = t.match(_)) &&
            ...
            function I(t, e) {
                var i,
                    ...
                    p = [];
                for (
                    c && ((a = e.left), (s = e.top), delete e.right, delete e.bottom, delete e.left, delete e.top),
                        i = n.length;
                    i--;
                ...
                return S.apply(n, [
                    ...
                    function (t, a, s) {
                        for (i = n.length; i--; )
                            for (var o in (c &&
                            ((s = D(p[i], t)), (n[i].style.left = s[0] + "px"), (n[i].style.top = s[1] + "px")),
                                e))
                                (a = N(t, _, u, m, o, i)),
                                    "transform" == o
                                        ? (n[i].style[f] = x(a))
            ...
            dt = (function () {
                ...
                return (
                    (E.matches = function (t, e) {
                        ...
                        var i =
                            t.webkitMatchesSelector || t.mozMatchesSelector || t.oMatchesSelector || t.matchesSelector;
            ...
            (function (t) {
                ...
                (t.active = 0),
                    ...
                    (t.ajax = function (a) {
                        ...
                        if ("jsonp" == p || v)
                            return (
                                v || (s.url = g(s.url, s.jsonp ? s.jsonp + "=?" : !1 === s.jsonp ? "" : "callback=?")),
                                    t.ajaxJSONP(s, n)
                            );
                        var y,
                            b = s.accepts[p],
        ...
        const ct = dt.getJSON,
            ...
            yt = it.extend({
                ...
                getDisplayDate: function (t, e) {
                    ...
                    t || (t = Nt.fallback),
                    t.constructor != Nt &&
                    (D("First argument to getDisplayDate must be type Language"), (t = Nt.fallback));
        ...
        function Pt(t) {
            ...
            if ((n ? (s = n.slice(1)) : 1 == (s = t.split(":")).length && (s = t.split(".")), s.length > 4))
        ...
        var qe = (function t() {
            ...
            const i = (e) => t(e);
            if (((i.version = "3.2.4"), (i.removed = []), !e || !e.document || 9 !== e.document.nodeType || !e.Element))
                ...
                Nt = function () {
                    ...
                    if (!Lt || Lt !== t) {
                        if (
                            ...
                            ($.tagNameCheck = t.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
                            t.CUSTOM_ELEMENT_HANDLING &&
                            ...
                            (w = (function (t, e) {
                                ...
                                try {
                                    ...
                                    return (
                                        console.warn("TrustedTypes policy " + s + " could not be created."), null
                                    );
                                }
                            })(_, n)),
            ...
            const Ft = function (t) {
                    ...
                    if (
                        ...
                        t.hasChildNodes() &&
                        !Pt(t.firstElementChild) &&
                        de(/<[/\w]/g, t.innerHTML) &&
                        de(/<[/\w]/g, t.textContent))
                    )
                        return Ct(t), !0;
                    ...
                    !(function (t) {
                                ...
                                : t.namespaceURI === _t
                                    ? e.namespaceURI === ft
                                        ...
                                        : e.namespaceURI === pt
                                            ...
                                            : Boolean(It[i])
                                    : t.namespaceURI === ft
                                        ? !(e.namespaceURI === pt && !kt[a]) &&
                                        !(e.namespaceURI === _t && !wt[a]) &&
                                        !It[i] &&
                                        (xt[i] || !At[i])
                        ...
                        ? (Ct(t), !0)
                        : ("noscript" !== a && "noembed" !== a && "noframes" !== a) ||
                        !de(/<\/no(script|embed|frames)/i, t.innerHTML)
                            ? (V &&
                            3 === t.nodeType &&
                            ((e = t.textContent),
                                Kt([D, N, A], (t) => {
                            ...
                            t.textContent !== e &&
                            (ee(i.removed, { element: t.cloneNode() }), (t.textContent = e))),
                ...
                qt = function (t, e, i) {
                    ...
                    if (G && !B[e] && de(I, e));
                        ...
                        if (
                            !(
                                (Ut(t) &&
                                    (($.tagNameCheck instanceof RegExp && de($.tagNameCheck, t)) ||
                                        ($.tagNameCheck instanceof Function && $.tagNameCheck(t))) &&
                                    (($.attributeNameCheck instanceof RegExp && de($.attributeNameCheck, e)) ||
                                        ($.attributeNameCheck instanceof Function && $.attributeNameCheck(e)))) ||
                                ("is" === e &&
                                    $.allowCustomizedBuiltInElements &&
                                    (($.tagNameCheck instanceof RegExp && de($.tagNameCheck, i)) ||
                                        ($.tagNameCheck instanceof Function && $.tagNameCheck(i))))
                            )
                        )
                            return !1;
                    } else if (ut[e]);
        ...
        class Ge {
            ...
            addEra(t) {
                ...
                this._processDates(t),
                    this._tidyFields(t),
                    this.eras.push({ start_date: t.start_date, end_date: t.end_date, headline: t.text.headline });
            }
            _assignID(t) {
                var e = t.unique_id;
                return (
            ...
            _processDates(t) {
                ...
                if (!(t.start_date instanceof e)) {
                    ...
                    if (((t.start_date = new e(i)), void 0 !== t.end_date && !(t.end_date instanceof e))) {
                        ...
                        s
                            ? (D("End date same as start date is redundant; dropping end date"), delete t.end_date)
                            : (t.end_date = new e(a));
                    }
                }
            }
        ...
        class Qe {
            ...
            _getTicks(t, e) {
                for (
                    var i = t._scaled_padding * e.factor, a = t._earliest - i, s = t._latest + i, n = [], o = a;
                    o < s;
                    o += e.factor
                )
        ...
        class ni {
            ...
            _initLayout() {
                ...
                this.end_date &&
                ((this.has_end_date = !0), (this._el.container.className = "tl-timeera tl-timeera-with-end")),
        ...
        class ri {
            ...
            _initLayout() {
                ...
                if (
                    ((this._el.date = v("h3", "tl-headline-date", this._el.headline_container)), "" != this.data.text)
                ) {
                    var e = "";
            ...
            createMedia() {
                ...
                (e = "tl-media-item tl-media-image"),
                    ...
                    this.data.alt
                        ...
                        : this.data.caption && (this._el.content_item.alt = q(this.data.caption)),
                    this.data.title
                ...
                if (e)
                    if (
                        ...
                        for (n = 0, o = e.length; n < o; ++n)
                            this.queue[t].push({ urls: [e[n]], callback: n === o - 1 ? i : null, obj: a, context: s });
                ...
                (n = t.html.split("</p>&mdash;")[0] + "</p></blockquote>"),
                    ...
                    (n = n.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).includes(
                        ...
                        : ((s += n),
                            (s += "<div class='vcard'>"),
                            (s +=
                                "<a href='" + i + "' class='twitter-date' rel='noopener' target='_blank'>" + a + "</a>"),
                            (s += "<img src='' class='tl-media-item tl-media-image'></a>"),
                            (s += "<div class='author'>"),
                            (s +=
                                "<a class='screen-name url' href='" + t.author_url + "' rel='noopener' target='_blank'>"),
        ...
        class Ci extends li {
            constructor(t, e, i) {
                super(t, e, i),
                    (this.iframe = qe.sanitize(this.data.url, { ADD_TAGS: ["iframe"], ADD_ATTR: ["frameborder"] }));
            }
            _loadMedia() {
                (this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe", this._el.content)),
        ...
        class $i {
            ...
            _dispatchVisibleTicksChange() {
                const delay = 50; // ms, umjesto vezano uz duration animacije
                ...
                this.ticks_change_timeout = setTimeout(() => {
                    const ticks = this.timeaxis.getVisibleTicks();

                    // Izračun centra prikaza u milisekundama
                    const leftStr = this._el.slider.style.left || "0px";
                    const sliderLeft = parseFloat(leftStr) || 0;
                    const centerPx = -sliderLeft + (this.options.width / 2);
                    const ppm = this.timescale._pixels_per_milli;   // px per ms
                    const earliest = this.timescale._earliest;      // ms
                    const centerMs = Math.round(earliest + (centerPx / ppm));
            ...
            _onMouseScroll(t) {
                ...
                // Legacy: wheelDeltaX / wheelDeltaY
                if (void 0 !== t.wheelDeltaX || void 0 !== t.wheelDeltaY) {
                    if (void 0 !== t.wheelDeltaX) {
                        // koristi horizontalni ako je dominantan
                        e = Math.abs(t.wheelDeltaX) > Math.abs(t.wheelDeltaY) ? t.wheelDeltaX / 6 : 0;
                    } else if (void 0 !== t.wheelDeltaY) {
                        e = t.wheelDeltaY / 6;
                    }
                }
                // Moderni: deltaX / deltaY (wheel event)
                else if ('deltaX' in t || 'deltaY' in t) {
                    let dx = t.deltaX || 0,
                        dy = t.deltaY || 0;
                    // deltaMode==1 znači jedinica su "linije": grubo pretvori u piksele
                    if (t.deltaMode === 1) { dx *= 16; dy *= 16; }
                    // koristimo horizontalni scroll; vertikalni ignoriramo (ili mapiraj po želji)
                    e = Math.abs(dx) > Math.abs(dy) ? -dx : 0;
                }
                ...
                if (i > a.left) i = a.left;
                else if (i < a.right) i = a.right;
                ...
                // DODANO: emit 'visible_ticks_change' (throttled)
                this._dispatchVisibleTicksChange();
            }
            _onDragMove(t) {
            ...
            _initEvents(){
                ...
                // DODANO: momentum i dragend da uhvatimo i inerciju
                this._swipable.on("momentum", this._onDragMove, this);
                this._swipable.on("dragend", this._onDragMove, this);
                ...
                // DODANO: moderni wheel event
                ht.addListener(this._el.container, "wheel", this._onMouseScroll, this);
        ...
        class Ui {
            ...
            _initLayout() {
                ...
                (this.has.text || this.has.headline) &&
                ((this._text = new ri(this.data.text, {
            ...
            _updateBackgroundDisplay() {
                ...
                (this._el.background.style.backgroundImage =
                    "url('" + this._background_media.getImageURL(this.options.width, this.options.height) + "')");
            }
            _setInteractive(t) {
        ...
        class Wi {
            ...
            _createSlides(t) {
                for (var e = 0; e < t.length; e++)
                    "" == t[e].unique_id && (t[e].unique_id = z(6, "tl-slide")), this._createSlide(t[e], !1, -1);
            }
            _removeSlide(t) {
            ...
            changeBackground(t) {
                ...
                t.color_value && "" != t.color_value
                    ? (e = M(t.color_value)) ||
                    (D("Invalid color value " + t.color_value), (e = this.options.default_bg_color))
            ...
            _initLayout() {
                this._el.container.classList.add("tl-storyslider"),
                    (this._nav.previous = new Bi(
                        { title: "Previous", description: "description" },
                        { direction: "previous" },
                        this._el.container
                    )),
                    (this._nav.next = new Bi(
                ...
                f &&
                ((this._swipable = new qi(this._el.slider_container_mask, this._el.slider_container, {
                    enable: { x: !0, y: !1 },
                    snap: !0,
                })),
                    this._swipable.enable(),
        ...
        class Zi {
            constructor(t, e, i) {
                if (
                    ...
                    a
                        ...
                        : (delete i.default_bg_color, D("Invalid default background color. Ignoring."));
                }
                var s, n;
                E(this.options, i),
            ...
            _translateError(t) {
                return (
                    t.hasOwnProperty("stack") && D(t.stack),
            ...
            _onTimeNavChange(t) {
                this.current_id != t.unique_id &&
                ((this.current_id = t.unique_id), this._storyslider.goToId(this.current_id), this._onChange(t));
            }
            _onZoomToggle(t) {
                "in" == t.zoom
            ...
            _onVisibleTicksChange(t) {
                ...
                // pripremi payload za vanjske listenere
                const payload = { visible_ticks: t.visible_ticks };

                if (t && typeof t.center_ms === 'number' && this.config && this.config.events && this.config.events.length) {
                    const center = t.center_ms;
                    let bestIdx = -1, bestDiff = Infinity;

                    for (let i = 0; i < this.config.events.length; i++) {
                        const ms = this.config.events[i].start_date.getTime();
                        const diff = Math.abs(ms - center);
                        if (diff < bestDiff) {
                            bestDiff = diff;
                            bestIdx = i;
                        }
                    ...
                    if (bestIdx >= 0) {
                        payload.unique_id = this.config.events[bestIdx].unique_id;
                        // slide_index (ako postoji title slide, pomakni za +1)
                        payload.index = this.config.title ? (bestIdx + 1) : bestIdx;
                    }
                    payload.center_ms = center;
                }

                // DODANO: re-emitiraj event iz Timeline instance
                this.fire("visible_ticks_change", payload);
            }
            _onForwardToEnd(t) {
