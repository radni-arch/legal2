...
OUT_FILE="${OUT_DIR}/tdd-test-queue.generated.json"

mkdir -p "$OUT_DIR"

echo "Generating TDD test queue from tests/ tree..."
echo "Output: $OUT_FILE"

# Use PHP (already present for Laravel) to safely generate JSON
php << 'PHP'
<?php
