...
use App\Http\Requests\Reasoning\EvaluateLogicRequest;
use App\Models\LegalCase;
use Illuminate\Support\Facades\Validator;
use Tests\TestCase;
use Tests\UsesTestDatabase;

class EvaluateLogicRequestTest extends TestCase
{
    ...
    {
        $request = new EvaluateLogicRequest;
        $validator = Validator::make([
            'argument' => 'All searches require warrants; this search had no warrant; therefore illegal',
        ], $request->rules());
